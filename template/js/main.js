...
/******/ 	var hotCurrentHash = "414f476871153fb54aef"; // eslint-disable-line no-unused-vars
	...
	var Test = function () {
	  ...
	  _createClass(Test, [{
	    ...
	    value: function autoChange() {
	      ...
	      var box = document.querySelectorAll('.responsive-img');
	      var interval = this.time;
	      var length = box.length;
	      this.count = 0;
	      box[0].classList.add('show');
	      var int = setInterval(function () {
	        return _this.slide(box, interval, length);
	      }, interval);
	    }
	  }, {
	    key: 'slide',
	    value: function slide(box, interval, length) {
	    ...
	    value: function moveRight() {
	      ...
	      right.addEventListener('click', function (e) {
	        box[_this2.count].classList.remove('show');
	        _this2.count++;
	        if (_this2.count >= 4) {
	          _this2.count = 0;
	        }
	        box[_this2.count].classList.add('show');
	    ...
	    value: function moveLeft() {
	      ...
	      left.addEventListener('click', function (e) {
	        box[_this3.count].classList.remove('show');
	        _this3.count--;
	        if (_this3.count < 0) {
	          _this3.count = 3;
	        }
	        box[_this3.count].classList.add('show');
